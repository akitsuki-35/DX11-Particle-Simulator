...
IMGUI_IMPL_API bool     ImGui_ImplWin32_Initialize(void* hwnd)
{
...
{
    ImGui_ImplWin32_Data* bd = ImGui_ImplWin32_GetBackendData();
    IM_ASSERT(bd != nullptr && "Context or backend not initialized? Did you call ImGui_ImplWin32_Initialize()?");
    ImGuiIO& io = ImGui::GetIO();
