...
//-------------------------------------------------------------------------
// - TableSettingsInitialize() [Internal]
...
static void TableSettingsInitialize(ImGuiTableSettings* settings, ImGuiID id, int columns_count, int columns_count_max)
{
...
ImGuiTableSettings* ImGui::TableSettingsCreate(ImGuiID id, int columns_count)
{
    ...
    TableSettingsInitialize(settings, id, columns_count, columns_count);
    return settings;
}
...
static void* TableSettingsHandler_ReadOpen(ImGuiContext*, ImGuiSettingsHandler*, const char* name)
{
    ...
    if (ImGuiTableSettings* settings = ImGui::TableSettingsFindByID(id))
    {
        ...
        {
            TableSettingsInitialize(settings, id, columns_count, settings->ColumnsCountMax); // Recycle
            return settings;
        }
        settings->ID = 0; // Invalidate storage, we won't fit because of a count change
    }
