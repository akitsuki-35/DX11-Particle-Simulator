...
IMGUI_API void              ImFontAtlasBuildInitialize(ImFontAtlas* atlas);
...
IMGUI_API bool              ImFontAtlasFontSourceInitialize(ImFontAtlas* atlas, ImFontConfig* src);
...
IMGUI_API void              ImFontAtlasPackInitialize(ImFontAtlas* atlas);
